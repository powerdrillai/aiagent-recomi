...
const handleChatButtonClick = (API_KEY: string, USER_ID: string) => {
...
export default function createChatbotButton(API_KEY: string, USER_ID: string) {
  // 按钮样式
  ...
  // 创建按钮
  const chatbotButton = Object.assign(document.createElement("button"), {
    type: "button",
    ariaLabel: "Open chat",
  });
  ...
  chatbotButton.addEventListener("click", () =>
    handleChatButtonClick(API_KEY, USER_ID),
  );
